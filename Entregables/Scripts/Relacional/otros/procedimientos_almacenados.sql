...
--
CREATE
OR REPLACE FUNCTION agregar_usuario(
    nombre VARCHAR,
    email VARCHAR,
    telefono VARCHAR,
    fecha_registro DATE,
...
--
CREATE
OR REPLACE FUNCTION registrar_visita(
    usuario_id INT,
...
VALUES
    (usuario_id, establecimiento_id, fecha, total);
...
--
CREATE
OR REPLACE FUNCTION agregar_review(
    usuario_id INT,
    establecimiento_id INT,
...
--
CREATE
OR REPLACE FUNCTION actualizar_rating_establecimiento(est_id INT) RETURNS VOID AS $ $ BEGIN
UPDATE
    establecimientos
SET
    rating = (
